  ...
  return (
    <div className="relative pt-20 flex items-center justify-center h-screen mx-2 ">
      <form
        ...
        className="relative flex flex-col dark:bg-white/5 justify-center gap-4 backdrop-blur-lg min-h-[55%] md:min-h-[60%] w-full max-w-md mx-2 md:mx-auto p-6 shadow-xl border border-gray-500/30 rounded-3xl"
      >
        ...
        <p className="text-center select-none text-black/40 dark:text-white mt-6 p-0.5 text-[16px] active:text-[15.8px]">
         ...
         <div className="absolute -top-34 w-100">
