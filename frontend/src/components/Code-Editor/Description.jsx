...
function Description() {
  ...
  if (loading && !problem) {
    return (
      <div className="animate-pulse px-5 py-8 space-y-5">
        <div className="h-15 bg-gray-300 dark:bg-gray-400/50 rounded w-2/3" />

        <div className="flex gap-2">
          <div className="h-8 w-16 bg-gray-300 dark:bg-gray-400/50 rounded" />
          <div className="h-8 w-24 bg-gray-300 dark:bg-gray-400/50 rounded" />
        </div>

        <div className="space-y-2">
          <div className="h-34 bg-gray-300 dark:bg-gray-400/50 rounded w-full" />
        </div>

        <div className="mt-6 space-y-2">
          <div className="h-10 bg-gray-300 dark:bg-gray-400/50 rounded w-32" />
          <div className="h-22 bg-gray-300 dark:bg-gray-400/50 rounded w-full" />
          <div className="h-10 bg-gray-300 dark:bg-gray-400/50 rounded w-32" />
          <div className="h-22 bg-gray-300 dark:bg-gray-400/50 rounded w-full" />
