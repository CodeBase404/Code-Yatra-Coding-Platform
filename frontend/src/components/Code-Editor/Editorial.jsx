  ...
  return (
    <div className="h-[100vh] w-full">
      ...
      >
        ...
        <div
          className={`absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/40 to-transparent pb-3 px-3 transition-opacity ${isHovering || !isPlaying ? "opacity-100" : "opacity-0"
            }`}
        >
          {/* Progress Bar */}
          <div className="flex items-center w-full mb-2">
            ...
            [&::-moz-range-thumb]:bg-white 
              ...
              style={{
                background: `linear-gradient(to right, #f97316 ${(currentTime / duration) * 100
          ...
          <div className="flex justify-between px-2 ">
            <div className="flex items-center gap-2">
              ...
              >
                ...
                >
                  <Volume2
                    className={`w-4 h-4 text-white group-hover:scale-110 transition-transform duration-200 ${isMuted ? "opacity-50" : ""
                      }`}
                  />
                </button>
                {showSlider && (
