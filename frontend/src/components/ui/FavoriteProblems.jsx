...
const FavoriteProblems = () => {
  ...
  return (
    <div className="border border-white/20 rounded-lg dark:border-white/10 mx-auto p-6 w-full">
      ...
      {favProblems?.length === 0 ? (
        ...
        <div className="grid gap-4 max-h-150 overflow-y-scroll scrollbar-hide">
