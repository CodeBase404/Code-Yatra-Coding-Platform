  ...
  return (
    <div className="h-[100vh] w-full bg-gradient-to-br from-blue-50 dark:from-neutral to-indigo-100 dark:to-neutral p-4">
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
        {/* Header */}
        <div className="relative bg-gradient-to-r from-blue-600 dark:from-gray-900 to-indigo-600 dark:to-gray-900 px-8 py-6">
          ...
          <div onClick={() => setShowResume(true)} className="absolute right-5 bottom-4 btn btn-soft btn-primary">My Resume</div>
          <div  onClick={() => setShowPortfolio(true)} className="absolute right-35 bottom-4 btn btn-soft btn-info hover:text-white">My Portfolio</div>
        </div>
