...
function ProblemsList({
  ...
  if (loading && !problems) {
    return (
      <div className="h-full space-y-2 pt-5">
        <div className="skeleton bg-white/30 h-20 rounded"></div>
        <div className="skeleton bg-white/30 h-20 rounded"></div>
        <div className="skeleton bg-white/30 h-20 rounded"></div>
        <div className="skeleton bg-white/30 h-20 rounded"></div>
        <div className="skeleton bg-white/30 h-20 rounded"></div>
    ...
    <div className={`relative space-y-3 rounded-xl w-full`}>
      <div className="flex flex-row items-center justify-between gap-2 w-full">
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-3 my-1 rounded-xl border border-black/20 dark:border-gray-400/15 transition-all duration-200 ${showFilter
        ...
        >
          ...
          <ChevronDown
            className={`h-4 w-4 transition-transform duration-200 ${showFilter ? "rotate-180" : ""
              }`}
          />
        </button>
      </div>
                          ...
                          <td className="px-6 py-4">
                            ...
                            >
                              ...
                              {!descHide && !descHideFromSidebar && (
                                <p
                                  className={`text-sm ${descHide ? "hidden" : "block"
