  ...
  return (
    <div className=" w-full flex items-center justify-center p-4">
      {show && (
        ...
        ><div onClick={() => setShow(false)} className="absolute top-1.5 right-1.5 btn btn-circle h-6 w-6">X</div>
          <div className="flex w-full justify-between gap-3 pt-2">
            <button
              onClick={() => handleModeChange("stopwatch")}
              className={`w-full h-20 border border-white/20 flex flex-col items-center justify-center gap-2 rounded-xl text-xs transition-all duration-300 ${mode === "stopwatch"
            ...
            <button
              ...
              className={`w-full h-20 border border-white/20 flex flex-col items-center justify-center gap-2 rounded-xl text-xs transition-all duration-300 ${mode === "timer"
